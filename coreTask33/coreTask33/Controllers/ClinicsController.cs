...
using coreTask33.Models;

namespace coreTask33.Controllers
{
    public class ClinicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClinicId,ClinicName,ClinicImg,ClinicDis")] Clinic clinic)
        {
